...
class Instructions(Page):
    def is_displayed(player: Player):
        ...
        return player.subsession.round_number == 1 and player.session.config['test']==0
...
class Questionnaire(Page):
    ...
    """Players payoff: How much each has earned"""
    def is_displayed(player: Player):
        return player.subsession.round_number == Constants.num_rounds and player.session.config['test']==0

page_sequence = [Instructions, WaitPage2,Control, WaitPage1,WaitPage0,Start, Contribute, ResultsWaitPage,ResultsWaitPage2, Results, WaitPage2, Diventa_ricco,ResultsWaitPage3,Final, Questionnaire]
