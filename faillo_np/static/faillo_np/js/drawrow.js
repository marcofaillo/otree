...
function aggiungi_primariga(){
	...
	nuova_riga = nuova_riga + "<div class=\"col-md-2 bordi_celle_intestazione\"><p>Pagamento</p></div> </div>";
	// alert(nuova_riga);
...
function aggiungi_altri(others,ng,guad,diff){
	...
	// }
	if (errore_imitazione > 0){
		nuova_riga = nuova_riga + "<div class=\"col-md-10 col-md-1sx bordi_celle_gray\">Un partecipante estratto a caso ha ottenuto un pagamento di</div>";
	}
	else {
		nuova_riga = nuova_riga + "<div class=\"col-md-10 col-md-1sx bordi_celle_gray\">Un partecipante estratto a caso ha ottenuto un pagamento di</div>";
	}
	...
	if (errore_imitazione > 0){
		...
		nuova_riga = nuova_riga + "<div class=\"col-md-10 col-md-1sx bordi_celle_gray\">Il numero di simboli diversi rispetto all'ultima immagine da te prodotta è</div>";
	...
	if (guad!=-1){
		...
		nb = "<button class=\"btn btn-outline-primary myclassimita \" id=\"" + name_button + "\">Imita l'immagine prodotta da questo/a partecipante</button>";
