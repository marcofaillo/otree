...
mgslider.prototype.markup = function () {
    return "\
        <table id='" + this.id("wrapper") + "' class='mgslider-wrapper' border='0'>\
            <tr>\
                <td class='mgslider-limit'>" + "0 Points" + "</td>\
                <td width='90%'>\
                ...
                <td class='mgslider-limit' style='white-space: nowrap; padding-left: 10px; padding-right: 10px;'>" + "10 Points" + "</td>\
            </tr>\
...
mgslider.prototype.change = function (target, omit_hook) {
    ...
    var complementaryValue = 2* value;
